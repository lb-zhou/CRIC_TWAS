...
mkdir /proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/afr_dgn/prediction/chunking/chunking.chr${chr}/


#tabix -p vcf /proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/afr_dgn/intersection/chr${chr}.subset1.vcf.gz

chunking=1
if [ $chunking == 1 ]
then
    WKDIR="/proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/afr_dgn/prediction"
    input="/proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/afr_dgn/intersection"
