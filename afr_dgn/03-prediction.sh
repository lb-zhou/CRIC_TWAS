...
# Weights path #
path_to_main="/proj/yunligrp/users/munan/BCT_TWAS_new/DGN"
out_res="/proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/afr_dgn"
...
while read -r start stop commonID; do
    ...
    sed 1d ${path_to_main}/training/training.chr${chr}/DGN.chr${chr}.${commonID}.betas.EN.txt | cut -f 1,2 > \
...
#prediction
	...
	-b ${path_to_main}/training/training.chr${chr}/DGN.chr${chr}.${commonID}.betas.EN.txt \
	-l ${path_to_main}/training/training.chr${chr}/DGN.chr${chr}.${commonID}.log \
...
done  <  gencode.chr${chr}.genes.temp
