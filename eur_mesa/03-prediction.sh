...
# Weights path #
path_to_main="/proj/yunligrp/users/munan/BCT_TWAS_new/MESA_AA"
out_res="/proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/eur_mesa"
...
while read -r chrom start stop commonID; do
    ...
    sed 1d ${path_to_main}/training/training.chr${chr}/MESA_AA.chr${chr}.${commonID}.betas.EN.txt | cut -f 1,2 > \
...
#prediction
    ...
    Rscript /proj/yunligrp/users/bmlin/CRIC_DGN_pipeline/scripts/pred_0.7.R -d ${out_res}/prediction/temp/DC/DC.chr${chr}/reformat.${commonID}.chr${chr}.dosage.gz \
	-s ${out_res}/prediction/temp/DC/DC.chr${chr}/snplist.chr${chr}.${commonID}.temp \
	-b ${path_to_main}/training/training.chr${chr}/MESA_AA.chr${chr}.${commonID}.betas.EN.txt \
	-l ${path_to_main}/training/training.chr${chr}/MESA_AA.chr${chr}.${commonID}.log \
